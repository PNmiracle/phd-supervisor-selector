...
- **"同步技能"** = 拉取最新版 Skill（保证你用的是最新策略）
- **"结束学生"** = 把这次搜索的经验存回去（更新策略库，让下次更准）

协作者不需要懂代码，不需要懂 git，全程用自然语言跟 AI 聊就行。

### 角色权限

| 角色 | 能做什么 | 不能做什么 |
|------|-----------|--------------|
| **管理员** | 直接 push main、合并 PR、改 SKILL.md 核心规则 | — |
| **协作者** | 开分支、提交、开 PR | 不能直接 push main |
...
（详见 [`协作者指南.md`](协作者指南.md)）

### Q：我忘了说"同步技能"就直接搜学生了，怎么办？

**没关系**，搜完学生后说"结束学生"时，AI 会先拉最新版本再提交。

### Q：我说"结束学生"后，AI 问我"要不要更新策略库"，我说"不"，会怎么样？
